...
/* default */class AspectAutoConfigurationTest {
	...
	@DisplayName("Should have KesselRunInformationLoggingAspect enabled by default")
	@Test
	...
	@DisplayName("Should have KesselRunExceptionLoggingAspect enabled by default")
	@Test
